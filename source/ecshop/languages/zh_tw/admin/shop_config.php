...
$_LANG['cfg_name']['share_title'] = '轉發標題';
$_LANG['cfg_desc']['share_title'] = '用於H5/小程序在微信環境下轉發顯示的標題（商品詳情頁轉發除外）';

$_LANG['cfg_name']['share_desc'] = '轉發描述';
$_LANG['cfg_desc']['share_desc'] = '用於h5在微信環境下轉發顯示的內容（商品詳情頁轉發除外）';
