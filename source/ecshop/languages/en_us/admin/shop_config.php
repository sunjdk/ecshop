...
$_LANG['cfg_name']['share_title'] = 'Share title';
$_LANG['cfg_desc']['share_title'] = 'Title for H5/Mini Program forwarding display in Wechat environment (except for merchandise details page forwarding)';

$_LANG['cfg_name']['share_desc'] = 'Share desc';
$_LANG['cfg_desc']['share_desc'] = 'Content for H5 forwarding display in Wechat environment (except for merchandise details page forwarding)';
